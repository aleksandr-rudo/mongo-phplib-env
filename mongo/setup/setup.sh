...
sleep 40
echo "Mongo started."
mongo --host mongo400:27017 --version
mongo --host mongo440:27017 --version
...
echo "Configuring..."
mongo --host mongo400:27017 --eval 'rs.initiate()'
mongo --host mongo440:27017 --eval 'rs.initiate()'
